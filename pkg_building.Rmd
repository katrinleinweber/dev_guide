...
* We request all submissions to use `roxygen2` for documentation.  `roxygen2` is [an R package](https://cran.r-project.org/package=roxygen2) that automatically compiles `.Rd` files to your `man` folder in your package from simple tags written above each function.
